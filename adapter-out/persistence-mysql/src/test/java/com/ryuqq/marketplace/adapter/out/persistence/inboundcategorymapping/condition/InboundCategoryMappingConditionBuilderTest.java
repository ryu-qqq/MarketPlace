...
/**
 * InboundCategoryMappingConditionBuilderTest - InboundCategoryMapping 조건 빌더 단위 테스트.
 *
 ...
 */
@Tag("unit")
@DisplayName("InboundCategoryMappingConditionBuilder 단위 테스트")
class InboundCategoryMappingConditionBuilderTest {

    private InboundCategoryMappingConditionBuilder conditionBuilder;

    @BeforeEach
    void setUp() {
        conditionBuilder = new InboundCategoryMappingConditionBuilder();
    }
    ...
    class SearchConditionTest {
        ...
        void searchCondition_WithSearchWordAndNullField_ReturnsUnifiedExpression() {
            // when
            BooleanExpression result = conditionBuilder.searchCondition(null, "신발");
        ...
        void searchCondition_WithExternalCodeField_ReturnsBooleanExpression() {
            ...
            BooleanExpression result =
                    conditionBuilder.searchCondition(
                            InboundCategoryMappingSearchField.EXTERNAL_CODE, "CAT001");
        ...
        void searchCondition_WithExternalNameField_ReturnsBooleanExpression() {
            ...
            BooleanExpression result =
                    conditionBuilder.searchCondition(
                            InboundCategoryMappingSearchField.EXTERNAL_NAME, "신발류");
        ...
        void searchCondition_WithNullSearchWord_ReturnsNull() {
            ...
            BooleanExpression result =
                    conditionBuilder.searchCondition(
                            InboundCategoryMappingSearchField.EXTERNAL_CODE, null);
        ...
        void searchCondition_WithBlankSearchWord_ReturnsNull() {
            ...
            BooleanExpression result =
                    conditionBuilder.searchCondition(
                            InboundCategoryMappingSearchField.EXTERNAL_NAME, "   ");
