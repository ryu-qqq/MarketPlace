package com.ryuqq.marketplace.adapter.out.persistence.shippingpolicy.condition;
...
/**
 * ShippingPolicyConditionBuilderTest - 배송 정책 조건 빌더 단위 테스트.
 *
 ...
 */
@Tag("unit")
@DisplayName("ShippingPolicyConditionBuilder 단위 테스트")
class ShippingPolicyConditionBuilderTest {

    private ShippingPolicyConditionBuilder conditionBuilder;

    @BeforeEach
    void setUp() {
        conditionBuilder = new ShippingPolicyConditionBuilder();
    }
