...
/**
 * RefundOutboxCommandAdapterTest - 환불 아웃박스 Command Adapter 단위 테스트.
 *
 * @author ryu-qqq
 * @since 1.1.0
 */
...
@DisplayName("RefundOutboxCommandAdapter 단위 테스트")
class RefundOutboxCommandAdapterTest {

    @Mock private RefundOutboxJpaRepository repository;
    @Mock private RefundOutboxJpaEntityMapper mapper;

    @InjectMocks private RefundOutboxCommandAdapter commandAdapter;
    ...
    class PersistTest {
        ...
        void persist_WithValidDomain_SavesAndReturnsId() {
            ...
            RefundOutboxJpaEntity savedEntity =
                    RefundOutboxJpaEntityFixtures.pendingEntity(
                            RefundOutboxJpaEntityFixtures.DEFAULT_ID);
        ...
        void persist_AfterSave_RefreshesVersionOnDomain() {
            ...
            RefundOutbox domain = RefundOutboxFixtures.pendingRefundOutbox();
            RefundOutboxJpaEntity entity = RefundOutboxJpaEntityFixtures.pendingEntity();
            RefundOutboxJpaEntity savedEntity = RefundOutboxJpaEntityFixtures.completedEntity();
    ...
    class PersistAllTest {
        ...
        void persistAll_WithMultipleDomains_SavesAll() {
            ...
            List<RefundOutbox> domains = List.of(domain1, domain2);
            ...
            ArgumentCaptor<List<RefundOutboxJpaEntity>> captor =
        ...
        void persistAll_AfterSave_RefreshesVersionOnEachDomain() {
            ...
            RefundOutboxJpaEntity entity1 = RefundOutboxJpaEntityFixtures.pendingEntity(1L);
            RefundOutboxJpaEntity entity2 = RefundOutboxJpaEntityFixtures.pendingEntity(2L);
            RefundOutboxJpaEntity saved1 = RefundOutboxJpaEntityFixtures.completedEntity();
            RefundOutboxJpaEntity saved2 = RefundOutboxJpaEntityFixtures.completedEntity();
        ...
        void persistAll_WithEmptyList_CallsSaveAll() {
            // given
            List<RefundOutbox> emptyList = List.of();
        ...
        void persistAll_CallsMapperForEachDomain() {
            ...
            RefundOutbox domain1 = RefundOutboxFixtures.pendingRefundOutbox();
            RefundOutbox domain2 = RefundOutboxFixtures.pendingRefundOutbox();
            RefundOutbox domain3 = RefundOutboxFixtures.pendingRefundOutbox();
            List<RefundOutbox> domains = List.of(domain1, domain2, domain3);
            ...
            then(mapper)
                    .should(times(3))
                    .toEntity(org.mockito.ArgumentMatchers.any(RefundOutbox.class));
        }
    }
}
