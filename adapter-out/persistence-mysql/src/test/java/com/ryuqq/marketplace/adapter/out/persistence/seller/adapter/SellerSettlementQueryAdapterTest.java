...
import com.ryuqq.marketplace.adapter.out.persistence.seller.repository.SellerSettlementQueryDslRepository;
...
/**
 * SellerSettlementQueryAdapterTest - 셀러 정산 정보 Query Adapter 단위 테스트.
 *
...
@DisplayName("SellerSettlementQueryAdapter 단위 테스트")
class SellerSettlementQueryAdapterTest {

    @Mock private SellerSettlementQueryDslRepository queryDslRepository;

    @Mock private SellerSettlementJpaEntityMapper mapper;

    @InjectMocks private SellerSettlementQueryAdapter queryAdapter;
    ...
    class FindByIdTest {
        ...
        @Test
        @DisplayName("ID로 정산 정보를 조회하여 Domain으로 변환합니다")
        void findById_WithValidId_ReturnsDomain() {
            // given
            SellerSettlementId id = SellerSettlementId.of(1L);
            ...
            // when
            Optional<SellerSettlement> result = queryAdapter.findById(id);
        ...
        void findById_WithNonExistentId_ReturnsEmpty() {
            // given
            SellerSettlementId id = SellerSettlementId.of(999L);
    ...
    class FindBySellerIdTest {
        ...
        @Test
        @DisplayName("셀러 ID로 정산 정보를 조회하여 Domain으로 변환합니다")
        void findBySellerId_WithValidSellerId_ReturnsDomain() {
            ...
            // when
            Optional<SellerSettlement> result = queryAdapter.findBySellerId(sellerId);
    ...
    class ExistsBySellerIdTest {
        ...
        @Test
        @DisplayName("셀러 ID로 정산 정보가 존재하면 true를 반환합니다")
        ...
        @Test
        @DisplayName("셀러 ID로 정산 정보가 존재하지 않으면 false를 반환합니다")
