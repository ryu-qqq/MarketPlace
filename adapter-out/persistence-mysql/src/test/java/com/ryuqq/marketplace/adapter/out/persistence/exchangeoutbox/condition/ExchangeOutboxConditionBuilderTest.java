...
/**
 * ExchangeOutboxConditionBuilderTest - 교환 아웃박스 조건 빌더 단위 테스트.
 *
 * @author ryu-qqq
 * @since 1.1.0
 */
@Tag("unit")
@DisplayName("ExchangeOutboxConditionBuilder 단위 테스트")
class ExchangeOutboxConditionBuilderTest {

    private ExchangeOutboxConditionBuilder conditionBuilder;

    @BeforeEach
    void setUp() {
        conditionBuilder = new ExchangeOutboxConditionBuilder();
    }
