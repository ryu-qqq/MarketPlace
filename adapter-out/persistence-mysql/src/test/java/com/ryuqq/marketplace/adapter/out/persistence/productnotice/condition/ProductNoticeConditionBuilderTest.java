...
/**
 * ProductNoticeConditionBuilderTest - 상품 고시정보 조건 빌더 단위 테스트.
 *
 ...
 */
@Tag("unit")
@DisplayName("ProductNoticeConditionBuilder 단위 테스트")
class ProductNoticeConditionBuilderTest {

    private ProductNoticeConditionBuilder conditionBuilder;

    @BeforeEach
    void setUp() {
        conditionBuilder = new ProductNoticeConditionBuilder();
    }
