package com.ryuqq.marketplace.adapter.out.persistence.externalproductsync.entity;
...
/**
 * ExternalProductSyncOutboxJpaEntity - 외부 상품 연동 Outbox JPA 엔티티.
 *
 ...
 */
@Entity
@Table(name = "external_product_sync_outboxes")
public class ExternalProductSyncOutboxJpaEntity {
    ...
    protected ExternalProductSyncOutboxJpaEntity() {}

    private ExternalProductSyncOutboxJpaEntity(
            Long id,
            Long productGroupId,
            Long salesChannelId,
            Long sellerId,
    ...
    public static ExternalProductSyncOutboxJpaEntity create(
            ...
            long version,
            String idempotencyKey) {
        return new ExternalProductSyncOutboxJpaEntity(
                id,
                productGroupId,
                salesChannelId,
                sellerId,
