...
/**
 * SellerAdminEmailOutboxJpaRepository - 셀러 관리자 이메일 Outbox JPA 레포지토리.
 *
 * <p>PER-REP-001: JpaRepository는 save/saveAll만 사용.
 *
 * <p>PER-REP-003: 모든 조회는 QueryDslRepository에서 처리.
 */
public interface SellerAdminEmailOutboxJpaRepository
        extends JpaRepository<SellerAdminEmailOutboxJpaEntity, Long> {}
