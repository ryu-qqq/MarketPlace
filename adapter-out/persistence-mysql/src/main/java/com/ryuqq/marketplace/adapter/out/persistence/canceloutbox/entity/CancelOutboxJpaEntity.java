package com.ryuqq.marketplace.adapter.out.persistence.canceloutbox.entity;
...
/** 취소 아웃박스 JPA 엔티티. */
@Entity
@Table(name = "cancel_outboxes")
public class CancelOutboxJpaEntity {
    ...
    protected CancelOutboxJpaEntity() {}
