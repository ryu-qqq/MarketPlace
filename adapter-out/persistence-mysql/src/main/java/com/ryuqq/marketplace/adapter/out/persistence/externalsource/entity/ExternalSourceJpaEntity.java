package com.ryuqq.marketplace.adapter.out.persistence.externalsource.entity;
...
public class ExternalSourceJpaEntity extends BaseAuditEntity {
    ...
    protected ExternalSourceJpaEntity() {
        super();
    }

    private ExternalSourceJpaEntity(
            Long id,
            String code,
            String name,
            String type,
    ...
    public static ExternalSourceJpaEntity create(
            Long id,
            String code,
            String name,
            String type,
            ...
            Instant createdAt,
            Instant updatedAt) {
        return new ExternalSourceJpaEntity(
