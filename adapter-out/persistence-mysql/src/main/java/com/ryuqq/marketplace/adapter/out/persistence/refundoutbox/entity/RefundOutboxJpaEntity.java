package com.ryuqq.marketplace.adapter.out.persistence.refundoutbox.entity;
...
/** 환불 아웃박스 JPA 엔티티. */
@Entity
@Table(name = "refund_outboxes")
public class RefundOutboxJpaEntity {
    ...
    protected RefundOutboxJpaEntity() {}

    @SuppressWarnings("PMD.ExcessiveParameterList")
    private RefundOutboxJpaEntity(
            Long id,
            String orderItemId,
            String outboxType,
            String status,
    ...
    @SuppressWarnings("PMD.ExcessiveParameterList")
    public static RefundOutboxJpaEntity create(
            Long id,
            String orderItemId,
            String outboxType,
            String status,
            ...
            long version,
            String idempotencyKey) {
        return new RefundOutboxJpaEntity(
