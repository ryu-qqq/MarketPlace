-- ============================================
-- 셀러 관리자 인증 Outbox 테이블
-- Transactional Outbox 패턴
-- @Version 낙관적 잠금 적용
-- ============================================

CREATE TABLE IF NOT EXISTS seller_admin_auth_outboxes (
    id BIGINT NOT NULL AUTO_INCREMENT COMMENT 'PK',
    seller_admin_id VARCHAR(36) NULL COMMENT '셀러 관리자 ID (UUIDv7)',
    ...
    INDEX idx_seller_admin_auth_outboxes_seller_admin_id (seller_admin_id),
    INDEX idx_seller_admin_auth_outboxes_status (status),
    INDEX idx_seller_admin_auth_outboxes_status_retry (status, retry_count)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='셀러 관리자 인증 Outbox';
