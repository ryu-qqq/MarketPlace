 ...
 *
 * <p>orders 테이블에서 활성 주문 ID와 결제 ID를 커서 기반으로 페이징 조회합니다. ORDER_FAILED 상태 제외, delete_yn='N' 조건 적용.
 *
 * @author ryu-qqq
 * @since 1.0.0
 */
...
public class LegacyOrderIdScanQueryDslRepository {
     ...
     *
     * <p>delete_yn='N' AND ORDER_STATUS != 'ORDER_FAILED' AND order_id > afterId 조건으로 order_id 오름차순
     * 조회합니다.
     *
