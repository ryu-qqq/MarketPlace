...
public class NaverCommerceClaimMapper {
    ...
    private ExternalClaimPayload toClaimPayload(
        ...
        String claimRequestReason = claim != null ? claim.claimRequestReason() : null;
        String claimRequestDetailContent = claim != null ? claim.claimRequestDetailContent() : null;
        Integer requestQuantity = claim != null ? claim.requestQuantity() : null;
        String requestChannel = claim != null ? claim.requestChannel() : null;
        String collectDeliveryCompany = claim != null ? claim.collectDeliveryCompany() : null;
        String collectTrackingNumber = claim != null ? claim.collectTrackingNumber() : null;
        String collectStatus = claim != null ? claim.collectStatus() : null;
