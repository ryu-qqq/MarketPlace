...
/**
 * 네이버 커머스 Circuit Breaker 설정.
 *
 * <p>네이버 커머스 API 장애 시 빠른 실패(fail-fast)를 통해 스레드 블로킹을 방지합니다.
 *
 * <ul>
 *   <li>실패율 50% 초과 시 OPEN
...
public class NaverCommerceCircuitBreakerConfig {

    private static final String CIRCUIT_BREAKER_NAME = "naverCommerce";
    ...
    /** OPEN → HALF_OPEN 전이 대기 시간. Rate Limit 해제 + 서버 복구 대기. */
    ...
    @Bean
    public CircuitBreaker naverCommerceCircuitBreaker() {
