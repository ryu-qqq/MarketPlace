...
public class NaverCommerceImageClientAdapter {
    ...
    public NaverCommerceImageClientAdapter(NaverCommerceApiClient apiClient) {
    ...
    public List<String> uploadFromUrls(List<String> imageUrls) {
        ...
        NaverImageUploadResponse response = apiClient.uploadImages(body);
    ...
    private ImageData downloadImage(String imageUrl) {
        try {
            ...
            try (InputStream in = conn.getInputStream()) {
                ...
                return new ImageData(bytes, filename, resolvedContentType);
            } finally {
                conn.disconnect();
            }
        } catch (IOException e) {
