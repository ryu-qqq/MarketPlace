...
class NaverSoldOutTest {
    ...
    void soldOutTest() throws Exception {
        ...
        NaverProductRegistrationRequest soldOutReq = mapper.toUpdateRequest(
                soldOutBundle, NAVER_CATEGORY_ID, null, existing, Set.of(ChangedArea.STATUS));

        String json = om.writeValueAsString(soldOutReq);
        System.out.println("요청 JSON (옵션 부분):");
        var optNode = om.readTree(json).path("originProduct").path("detailAttribute").path("optionInfo");
        System.out.println(om.writeValueAsString(optNode));
        System.out.println("stockQuantity: " + om.readTree(json).path("originProduct").path("stockQuantity").asInt());
        System.out.println("statusType: " + om.readTree(json).path("originProduct").path("statusType").asText());

        // 3. 네이버 수정 호출
        System.out.println("\n===== 3. 네이버 수정 =====");
        HttpResponse<String> resp = putJson(http, token,
                NaverAuthHelper.BASE_URL + "/v2/products/origin-products/" + ORIGIN_PRODUCT_NO, json);
        ...
        NaverProductRegistrationRequest activeReq = mapper.toUpdateRequest(
                activeBundle, NAVER_CATEGORY_ID, null, after, Set.of(ChangedArea.STATUS));
        HttpResponse<String> restoreResp = putJson(http, token,
                NaverAuthHelper.BASE_URL + "/v2/products/origin-products/" + ORIGIN_PRODUCT_NO,
    ...
    private ProductGroupDetailBundle buildBundle(ProductGroupStatus status) {
        ...
        SellerOptionGroup sizeGroup = SellerOptionGroup.reconstitute(
                SellerOptionGroupId.of(1L), ProductGroupId.of(77288L),
                OptionGroupName.of("사이즈"), CanonicalOptionGroupId.of(1L),
                OptionInputType.FREE_INPUT, 0,
                List.of(
                        SellerOptionValue.reconstitute(SellerOptionValueId.of(1L), SellerOptionGroupId.of(1L),
                                OptionValueName.of("10"), CanonicalOptionValueId.of(1L), 0, DeletionStatus.active()),
                        SellerOptionValue.reconstitute(SellerOptionValueId.of(2L), SellerOptionGroupId.of(1L),
                                OptionValueName.of("12"), CanonicalOptionValueId.of(2L), 1, DeletionStatus.active()),
                        SellerOptionValue.reconstitute(SellerOptionValueId.of(3L), SellerOptionGroupId.of(1L),
                                OptionValueName.of("13"), CanonicalOptionValueId.of(3L), 2, DeletionStatus.active()),
                        SellerOptionValue.reconstitute(SellerOptionValueId.of(4L), SellerOptionGroupId.of(1L),
                                OptionValueName.of("14"), CanonicalOptionValueId.of(4L), 3, DeletionStatus.active())),
        ...
        ProductGroup group = ProductGroup.reconstitute(
                ProductGroupId.of(77288L), SellerId.of(25L), BrandId.of(421L),
                CategoryId.of(2382L), ShippingPolicyId.of(36L), RefundPolicyId.of(35L),
                ProductGroupName.of("[네이버 테스트 상품 준비] 디즈니 엘사 겨울왕국 부츠 2"),
                OptionType.SINGLE, status,
                List.of(ProductGroupImage.reconstitute(ProductGroupImageId.of(1L), ProductGroupId.of(77288L),
                        ImageUrl.of(IMAGE_URL), ImageUrl.of(IMAGE_URL), ImageType.THUMBNAIL, 0, DeletionStatus.active())),
                List.of(sizeGroup), now, now);

        NoticeCategory nc = NoticeCategory.reconstitute(NoticeCategoryId.of(2L),
                NoticeCategoryCode.of("SHOES"), NoticeCategoryName.of("SHOES", "신발"),
                CategoryGroup.CLOTHING, true,
                List.of(NoticeField.reconstitute(NoticeFieldId.of(9L), NoticeFieldCode.of("material"), NoticeFieldName.of("material"), true, 1),
                        NoticeField.reconstitute(NoticeFieldId.of(10L), NoticeFieldCode.of("sole"), NoticeFieldName.of("sole"), true, 2),
                        NoticeField.reconstitute(NoticeFieldId.of(11L), NoticeFieldCode.of("color"), NoticeFieldName.of("color"), true, 3),
                        NoticeField.reconstitute(NoticeFieldId.of(12L), NoticeFieldCode.of("size"), NoticeFieldName.of("size"), true, 4),
                        NoticeField.reconstitute(NoticeFieldId.of(13L), NoticeFieldCode.of("manufacturer"), NoticeFieldName.of("manufacturer"), true, 5),
                        NoticeField.reconstitute(NoticeFieldId.of(14L), NoticeFieldCode.of("origin"), NoticeFieldName.of("origin"), true, 6),
                        NoticeField.reconstitute(NoticeFieldId.of(15L), NoticeFieldCode.of("caution"), NoticeFieldName.of("caution"), true, 7)),
                now, now);

        ProductNotice notice = ProductNotice.reconstitute(ProductNoticeId.of(1L), ProductGroupId.of(77288L), NoticeCategoryId.of(2L),
                List.of(
                        ProductNoticeEntry.reconstitute(ProductNoticeEntryId.of(1L), ProductNoticeId.of(1L), NoticeFieldId.of(9L), NoticeFieldValue.of("합성가죽")),
                        ProductNoticeEntry.reconstitute(ProductNoticeEntryId.of(2L), ProductNoticeId.of(1L), NoticeFieldId.of(10L), NoticeFieldValue.of("TPR")),
                        ProductNoticeEntry.reconstitute(ProductNoticeEntryId.of(3L), ProductNoticeId.of(1L), NoticeFieldId.of(11L), NoticeFieldValue.of("블루")),
                        ProductNoticeEntry.reconstitute(ProductNoticeEntryId.of(4L), ProductNoticeId.of(1L), NoticeFieldId.of(12L), NoticeFieldValue.of("10/12/13/14호")),
                        ProductNoticeEntry.reconstitute(ProductNoticeEntryId.of(5L), ProductNoticeId.of(1L), NoticeFieldId.of(13L), NoticeFieldValue.of("(주)디즈니코리아")),
                        ProductNoticeEntry.reconstitute(ProductNoticeEntryId.of(6L), ProductNoticeId.of(1L), NoticeFieldId.of(14L), NoticeFieldValue.of("베트남")),
                        ProductNoticeEntry.reconstitute(ProductNoticeEntryId.of(7L), ProductNoticeId.of(1L), NoticeFieldId.of(15L), NoticeFieldValue.of("관련 법에 따름"))),
                now, now);

        SellerCs sellerCs = SellerCs.reconstitute(SellerCsId.of(1L), SellerId.of(25L),
        ...
        ProductGroupDescription desc = ProductGroupDescription.reconstitute(
                ProductGroupDescriptionId.of(1L), ProductGroupId.of(77288L),
                DescriptionHtml.of("<p>품절 테스트</p>"), CdnPath.of("https://cdn.test.com/test.html"),
                DescriptionPublishStatus.PUBLISHED, List.of(), now, now);

        ShippingPolicyResult shipping = new ShippingPolicyResult(36L, 25L, "기본", true, true,
                "FREE", "무료배송", 0L, null, 3000L, 5000L, 3000L, 6000L, 1, 3, LocalTime.of(14, 0), now, now);

        ProductGroupDetailCompositeQueryResult qr = new ProductGroupDetailCompositeQueryResult(
                77288L, 25L, "테스트 셀러", 421L, "디즈니", 2382L, "테스트", "테스트", "2382",
                "[네이버 테스트 상품 준비] 디즈니 엘사 겨울왕국 부츠 2",
                "SINGLE", status.name(), now, now, shipping, null);

        return new ProductGroupDetailBundle(qr, group, products,
                Optional.of(desc), Optional.of(notice), Optional.of(nc), Optional.of(sellerCs), Map.of());
    }

    private Product buildProduct(long id, String sku, int price, int stock, int sort, List<Long> optionValueIds) {
        ...
        for (int i = 0; i < optionValueIds.size(); i++) {
            mappings.add(ProductOptionMapping.reconstitute(
                    ...
                    SellerOptionValueId.of(optionValueIds.get(i)), DeletionStatus.active()));
        }
        Instant now = Instant.now();
        return Product.reconstitute(ProductId.of(id), ProductGroupId.of(77288L),
                SkuCode.of(sku), Money.of(price + 10000), Money.of(price), Money.of(price),
                20, stock, ProductStatus.ACTIVE, sort, mappings, now, now);
    }

    private NaverProductDetailResponse fetchDetail(HttpClient http, String token, long no) throws Exception {
    ...
    private HttpResponse<String> putJson(HttpClient http, String token, String url, String json) throws Exception {
