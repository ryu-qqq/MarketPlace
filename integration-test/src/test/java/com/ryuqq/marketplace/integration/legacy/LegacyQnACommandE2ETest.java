...
class LegacyQnACommandE2ETest extends LegacyE2ETestBase {
    ...
    // ===== POST /api/v1/legacy/qna/reply - 답변 등록 =====
    ...
    class AnswerQna_PendingToAnsweredTest {
        ...
        @Test
        @Tag("P0")
        @DisplayName("[LC1] PENDING 상태 QnA에 답변 등록 -> 200, QnA ANSWERED 전이, reply 생성, Outbox 생성")
    ...
    class AnswerQna_AlreadyAnsweredTest {
        ...
        @Test
        @Tag("P0")
        @DisplayName("[LC2] ANSWERED 상태 QnA에 답변 시도 -> 409 (상태 전이 불가)")
    ...
    class AnswerQna_ClosedQnaTest {
        ...
        @Test
        @Tag("P0")
        @DisplayName("[LC3] CLOSED 상태 QnA에 답변 시도 -> 409")
    ...
    // ===== PUT /api/v1/legacy/qna/reply - 답변 수정 =====
    ...
    @Nested
    @DisplayName("LC7: PUT /api/v1/legacy/qna/reply - 존재하지 않는 QnA의 답변 수정 -> 200 (레거시 NOT_FOUND)")
    class UpdateReply_NonExistentQnaTest {

        @Test
        @Tag("P0")
        @DisplayName("[LC7] 존재하지 않는 QnA ID에 대한 답변 수정 -> 200 (레거시 NOT_FOUND는 200 + body에 에러)")
