 ...
 * <p>특징:
 * <ul>
 *   <li>LegacyApiApplication 컨텍스트 로드</li>
 *   <li>실제 MySQL 컨테이너 사용 (레거시 DataSource도 동일 컨테이너)</li>
 *   <li>실제 Redis 컨테이너 사용 (Redisson Mock 불필요)</li>
 *   <li>레거시 JWT 인증: Authorization: Bearer 헤더</li>
 *   <li>basePath: "" (레거시 전용 경로)</li>
 * </ul>
 *
 * @author ryu-qqq
 * @since 1.0.0
...
public abstract class ContainerLegacyE2ETestBase {
    ...
    static void configureContainers(DynamicPropertyRegistry registry) {
        ...
        registry.add("persistence.legacy.datasource.driver-class-name",
                () -> "com.mysql.cj.jdbc.Driver");
        registry.add("persistence.legacy.datasource.jdbc-url",
                () -> TestContainersConfig.MYSQL.getJdbcUrl());
        registry.add("persistence.legacy.datasource.username",
                TestContainersConfig.MYSQL::getUsername);
        registry.add("persistence.legacy.datasource.password",
                TestContainersConfig.MYSQL::getPassword);
    }
     ...
     *
     * <p>StubLegacyTokenClient가 모든 토큰을 valid로 처리합니다.
     * sellerId=10, role=MASTER, email=stub@example.com 반환.
     */
