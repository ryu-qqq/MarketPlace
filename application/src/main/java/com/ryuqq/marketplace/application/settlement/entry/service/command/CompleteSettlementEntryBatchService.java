...
/** 정산 원장 일괄 완료(CONFIRMED) 배치 서비스. */
@Service
public class CompleteSettlementEntryBatchService implements CompleteSettlementEntryBatchUseCase {
    ...
    public CompleteSettlementEntryBatchService(
    ...
    @Override
    public void execute(CompleteSettlementEntryBatchCommand command) {
