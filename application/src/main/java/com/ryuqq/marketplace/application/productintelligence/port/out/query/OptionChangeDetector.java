...
/**
 * Option 입력 데이터 변경 감지기.
 *
 * <p>현재 상품 옵션 데이터와 이전 분석 시점의 데이터를 비교하여 재분석 필요 여부를 판단합니다. Approach B(Analyzer Self-Judgment)의 핵심
 ...
 * </ul>
 */
public interface OptionChangeDetector {

    /**
     * 상품 옵션 데이터가 이전 분석 시점 대비 변경되었는지 확인합니다.
     *
     * @param productGroupId 상품그룹 ID
     * @param previousResults 이전 프로파일의 분석 결과
     * @return 변경 감지 시 true, 변경 없으면 false
     */
    boolean hasChanged(Long productGroupId, List<OptionMappingSuggestion> previousResults);
}
