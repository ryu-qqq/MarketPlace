...
/** Intelligence Pipeline Outbox Query Port. */
public interface IntelligenceOutboxQueryPort {
     ...
     * @return Outbox 목록
     */
    List<IntelligenceOutbox> findPendingOutboxes(Instant beforeTime, int limit);
     ...
     * @return Outbox 목록
     */
    List<IntelligenceOutbox> findInProgressTimeoutOutboxes(Instant timeoutThreshold, int limit);
     ...
     * @return Outbox
     */
    Optional<IntelligenceOutbox> findById(Long outboxId);
}
