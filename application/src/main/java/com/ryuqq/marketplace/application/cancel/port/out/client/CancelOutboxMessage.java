...
public record CancelOutboxMessage(
        Long outboxId, Long orderItemId, String outboxType, String claimDomain) {

    public static CancelOutboxMessage of(Long outboxId, Long orderItemId, String outboxType) {
