package com.ryuqq.marketplace.application.legacyseller.port.out;
 ...
 * 반환 타입은 표준 {@link SellerAdminCompositeResult}이며,
 * 레거시 테이블 구조를 표준 객체로 매핑하는 책임은 adapter-out에 있습니다.
 */
