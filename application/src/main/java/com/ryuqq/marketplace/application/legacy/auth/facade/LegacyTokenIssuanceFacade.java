package com.ryuqq.marketplace.application.legacy.auth.facade;

import com.ryuqq.marketplace.application.legacy.auth.dto.result.LegacyTokenResult;
import com.ryuqq.marketplace.application.legacy.auth.manager.LegacyTokenCacheCommandManager;
