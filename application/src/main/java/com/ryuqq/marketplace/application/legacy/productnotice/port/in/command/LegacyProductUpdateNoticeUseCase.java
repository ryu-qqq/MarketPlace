package com.ryuqq.marketplace.application.legacy.productnotice.port.in.command;
 ...
 *
 * <p>표준 커맨드를 받되, luxurydb에 저장합니다. NoticeCategory를 함께 받아 entries → flat 필드 역매핑에 사용합니다.
 */
