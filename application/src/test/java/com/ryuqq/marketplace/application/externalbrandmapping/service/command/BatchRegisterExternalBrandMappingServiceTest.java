...
@DisplayName("BatchRegisterExternalBrandMappingService 단위 테스트")
class BatchRegisterExternalBrandMappingServiceTest {

    @InjectMocks private BatchRegisterExternalBrandMappingService sut;
        ...
        void execute_ValidBatchCommand_ReturnsMappingIds() {
            ...
            List<ExternalBrandMapping> mappings =
                    List.of(
                            ...
                            ExternalBrandMappingFixtures.newMapping(1L, "BR003", 300L));
