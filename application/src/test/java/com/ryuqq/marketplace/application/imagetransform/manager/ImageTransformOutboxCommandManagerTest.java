...
@DisplayName("ImageTransformOutboxCommandManager 단위 테스트")
class ImageTransformOutboxCommandManagerTest {

    @InjectMocks private ImageTransformOutboxCommandManager sut;

    @Mock private ImageTransformOutboxCommandPort commandPort;
    ...
    class PersistAllTest {
        ...
        void persistAll_EmptyList_DoesNotPersist() {
            // given
            List<ImageTransformOutbox> emptyOutboxes = List.of();
