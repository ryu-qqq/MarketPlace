 ...
 *
 * <p>{@link LegacyAuthContextHolder}에서 인증 정보를 직접 조회합니다.
 * 표준 API의 {@code MarketAccessChecker}와 달리 Gateway 헤더가 아닌
 * JWT claims 기반으로 동작합니다.
 *
 * <p>역할 기반 권한:
 * <ul>
 *   <li>MASTER — 모든 리소스 접근 가능 (SUPER_ADMIN 동등)</li>
 *   <li>SELLER — 본인 소유 리소스만 접근 가능</li>
 * </ul>
 *
...
public class LegacyAccessChecker {
    ...
    /**
     * 현재 인증된 셀러 ID를 반환합니다.
     * MASTER이면 null (전체 접근), SELLER이면 본인 셀러 ID.
     *
