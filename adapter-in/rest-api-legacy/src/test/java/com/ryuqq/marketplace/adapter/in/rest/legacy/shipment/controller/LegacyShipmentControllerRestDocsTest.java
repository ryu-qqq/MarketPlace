...
class LegacyShipmentControllerRestDocsTest {
    ...
    class GetCompanyCodesTest {
        ...
        void getCompanyCodes_Success() throws Exception {
            ...
            given(legacyGetShipmentCompanyCodesUseCase.execute()).willReturn(codes);
            given(legacyShipmentQueryApiMapper.toCompanyCodeResponses(anyList()))
                    .willReturn(LegacyShipmentApiFixtures.responses());
