...
class LegacySessionControllerRestDocsTest {
    ...
    class GetContentTest {
        ...
        void getContent_Success() throws Exception {
            ...
            given(mapper.toCommand(any())).willReturn(LegacySessionApiFixtures.command());
            given(legacyGetPresignedUrlUseCase.execute(any()))
                    .willReturn(LegacySessionApiFixtures.presignedUrlResponse());
