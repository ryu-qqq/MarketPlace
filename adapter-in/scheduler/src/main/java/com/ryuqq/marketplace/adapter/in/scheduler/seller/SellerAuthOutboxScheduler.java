package com.ryuqq.marketplace.adapter.in.scheduler.seller;
...
import com.ryuqq.marketplace.application.seller.dto.command.ProcessPendingOutboxCommand;
import com.ryuqq.marketplace.application.seller.dto.command.RecoverTimeoutOutboxCommand;
import com.ryuqq.marketplace.application.seller.port.in.command.ProcessPendingOutboxUseCase;
import com.ryuqq.marketplace.application.seller.port.in.command.RecoverTimeoutOutboxUseCase;
import org.springframework.boot.autoconfigure.condition.ConditionalOnProperty;
import org.springframework.scheduling.annotation.Scheduled;
import org.springframework.stereotype.Component;

/**
 * 셀러 인증 Outbox 처리 스케줄러.
 *
 * <p>두 가지 작업을 수행합니다:
 *
 * <ul>
...
@ConditionalOnProperty(
        prefix = "scheduler.jobs.seller-auth-outbox.process-pending",
        name = "enabled",
        havingValue = "true",
        matchIfMissing = true)
public class SellerAuthOutboxScheduler {

    private final ProcessPendingOutboxUseCase processPendingOutboxUseCase;
    private final RecoverTimeoutOutboxUseCase recoverTimeoutOutboxUseCase;
    private final SchedulerProperties.SellerAuthOutbox config;

    public SellerAuthOutboxScheduler(
            ProcessPendingOutboxUseCase processPendingOutboxUseCase,
            RecoverTimeoutOutboxUseCase recoverTimeoutOutboxUseCase,
        ...
        this.config = schedulerProperties.jobs().sellerAuthOutbox();
    }
