...
@Tag("unit")
@WebMvcTest(InboundCategoryMappingQueryController.class)
@AutoConfigureMockMvc(addFilters = false)
@AutoConfigureRestDocs
@DisplayName("InboundCategoryMappingQueryController REST Docs 테스트")
class InboundCategoryMappingQueryControllerRestDocsTest {
    ...
    @MockitoBean private SearchInboundCategoryMappingUseCase searchUseCase;
    @MockitoBean private InboundCategoryMappingQueryApiMapper mapper;
    @MockitoBean private ErrorMapperRegistry errorMapperRegistry;

    @Nested
    @DisplayName("인바운드 카테고리 매핑 목록 검색 API")
    class SearchTest {
        ...
        void search_ValidRequest_Returns200WithPage() throws Exception {
            ...
            PageApiResponse<InboundCategoryMappingApiResponse> pageResponse =
                    PageApiResponse.of(
                            List.of(
                                    InboundCategoryMappingApiFixtures.apiResponse(1L),
                                    InboundCategoryMappingApiFixtures.apiResponse(2L),
                                    InboundCategoryMappingApiFixtures.apiResponse(3L)),
                            0,
                            20,
                            3);
            ...
            given(mapper.toPageResponse(any(InboundCategoryMappingPageResult.class)))
        ...
        void search_WithFilters_Returns200() throws Exception {
            // given
            InboundCategoryMappingPageResult pageResult =
                    InboundCategoryMappingApiFixtures.pageResult(1, 0, 20);
            PageApiResponse<InboundCategoryMappingApiResponse> pageResponse =
                    PageApiResponse.of(
                            List.of(InboundCategoryMappingApiFixtures.apiResponse(1L)), 0, 20, 1);
        ...
        void search_EmptyResult_Returns200WithEmptyPage() throws Exception {
            ...
            PageApiResponse<InboundCategoryMappingApiResponse> emptyResponse =
