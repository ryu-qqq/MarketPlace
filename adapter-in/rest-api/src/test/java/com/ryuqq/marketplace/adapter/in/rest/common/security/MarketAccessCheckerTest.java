...
class MarketAccessCheckerTest {
    ...
    void setUp() {
        ...
        sut =
                new TestableMarketAccessChecker(
                        resolveSellerIdUseCase, resolveSellerIdBySellerAdminIdUseCase);
    }
    ...
    private static class TestableMarketAccessChecker extends MarketAccessChecker {
        ...
        TestableMarketAccessChecker(
            ...
            this(resolveSellerIdUseCase, resolveSellerIdBySellerAdminIdUseCase, false, false, null);
        }
        ...
        TestableMarketAccessChecker(
            ...
            super(resolveSellerIdUseCase, resolveSellerIdBySellerAdminIdUseCase);
