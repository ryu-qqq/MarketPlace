...
/**
 * SellerApplicationErrorMapper - 셀러 입점 신청 도메인 예외를 HTTP 응답으로 변환.
 *
 ...
 */
@Component
public class SellerApplicationErrorMapper implements ErrorMapper {

    private static final String ERROR_TYPE_PREFIX = "/errors/seller-application";

    @Override
    public boolean supports(DomainException ex) {
        return ex instanceof SellerApplicationException;
    }
