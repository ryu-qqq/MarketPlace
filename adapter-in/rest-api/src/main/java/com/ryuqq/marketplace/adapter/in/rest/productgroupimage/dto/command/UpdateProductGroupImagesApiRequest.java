package com.ryuqq.marketplace.adapter.in.rest.productgroupimage.dto.command;
 ...
 */
@Schema(description = "상품 그룹 이미지 수정 요청")
public record UpdateProductGroupImagesApiRequest(
        @Schema(description = "수정할 이미지 목록", requiredMode = Schema.RequiredMode.REQUIRED)
