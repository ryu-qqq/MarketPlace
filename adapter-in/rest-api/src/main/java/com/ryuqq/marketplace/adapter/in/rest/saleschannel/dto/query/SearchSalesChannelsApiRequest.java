...
public record SearchSalesChannelsApiRequest(
        ...
        @Parameter(description = "검색 필드 (CHANNEL_NAME)", example = "CHANNEL_NAME")
                String searchField,
        @Parameter(description = "검색어", example = "쿠팡") String searchWord,
        @Parameter(
                        description = "정렬 키 (CREATED_AT, CHANNEL_NAME, 기본값: CREATED_AT)",
                        example = "CREATED_AT")
                String sortKey,
