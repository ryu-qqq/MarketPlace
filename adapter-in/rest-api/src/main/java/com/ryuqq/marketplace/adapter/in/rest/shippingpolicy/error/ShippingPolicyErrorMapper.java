...
/**
 * ShippingPolicyErrorMapper - 배송정책 도메인 예외를 HTTP 응답으로 변환.
 *
 ...
 */
@Component
public class ShippingPolicyErrorMapper implements ErrorMapper {

    private static final String ERROR_TYPE_PREFIX = "/errors/shipping-policy";

    @Override
    public boolean supports(DomainException ex) {
        return ex instanceof ShippingPolicyException;
    }
