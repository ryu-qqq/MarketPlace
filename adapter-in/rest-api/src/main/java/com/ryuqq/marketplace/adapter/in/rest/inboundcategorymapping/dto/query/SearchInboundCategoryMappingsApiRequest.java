package com.ryuqq.marketplace.adapter.in.rest.inboundcategorymapping.dto.query;

import io.swagger.v3.oas.annotations.Parameter;

/** 외부 카테고리 매핑 검색 요청 DTO. */
public record SearchInboundCategoryMappingsApiRequest(
        @Parameter(description = "검색 필드 (EXTERNAL_CODE, EXTERNAL_NAME)", example = "EXTERNAL_NAME")
                String searchField,
        @Parameter(description = "검색어", example = "남성의류") String searchWord,
