package com.ryuqq.marketplace.adapter.in.rest.sellerapplication.dto.query;
...
public record SearchSellerApplicationsApiRequest(
        @Parameter(
                        ...
                        example = "PENDING")
                List<String> status,
        @Parameter(description = "검색 필드 (COMPANY_NAME, REPRESENTATIVE_NAME)", example = "companyName")
                String searchField,
