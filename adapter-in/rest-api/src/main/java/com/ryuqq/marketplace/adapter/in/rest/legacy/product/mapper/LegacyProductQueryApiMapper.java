...
import com.ryuqq.marketplace.adapter.in.rest.legacy.product.dto.response.LegacyProductDetailApiResponse.LegacyBrandResponse;
import com.ryuqq.marketplace.adapter.in.rest.legacy.product.dto.response.LegacyProductDetailApiResponse.LegacyClothesDetailResponse;
import com.ryuqq.marketplace.adapter.in.rest.legacy.product.dto.response.LegacyProductDetailApiResponse.LegacyDeliveryNoticeResponse;
import com.ryuqq.marketplace.adapter.in.rest.legacy.product.dto.response.LegacyProductDetailApiResponse.LegacyPriceResponse;
import com.ryuqq.marketplace.adapter.in.rest.legacy.product.dto.response.LegacyProductDetailApiResponse.LegacyProductGroupInfoResponse;
import com.ryuqq.marketplace.adapter.in.rest.legacy.product.dto.response.LegacyProductDetailApiResponse.LegacyProductImageResponse;
import com.ryuqq.marketplace.adapter.in.rest.legacy.product.dto.response.LegacyProductDetailApiResponse.LegacyProductNoticeResponse;
import com.ryuqq.marketplace.adapter.in.rest.legacy.product.dto.response.LegacyProductDetailApiResponse.LegacyRefundNoticeResponse;
 ...
 */
@Component
public class LegacyProductQueryApiMapper {

    /**
     * 상품그룹 상세 결과 → API 응답 변환.
     *
     * @param result 레거시 상품그룹 상세 결과
     * @return 세토프 호환 API 응답
     */
