package com.ryuqq.marketplace.adapter.in.rest.commoncode.dto.command;
...
/**
 * UpdateCommonCodeApiRequest - 공통 코드 수정 API 요청.
 *
 ...
 * @since 1.0.0
 */
@Schema(description = "공통 코드 수정 요청")
public record UpdateCommonCodeApiRequest(
