package com.ryuqq.marketplace.adapter.in.rest.categorypreset.dto.query;

import io.swagger.v3.oas.annotations.Parameter;
import java.util.List;

/** 카테고리 프리셋 검색 API 요청 DTO. */
public record SearchCategoryPresetsApiRequest(
        ...
        @Parameter(
                        description =
                                "검색 필드 (PRESET_NAME, SHOP_NAME, ACCOUNT_ID, CATEGORY_CODE,"
                                        + " CATEGORY_PATH)",
                        example = "PRESET_NAME")
                String searchField,
        @Parameter(description = "검색어", example = "식품") String searchWord,
