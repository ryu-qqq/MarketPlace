...
/** 취소 목록 검색 요청. */
@Schema(description = "취소 목록 검색 요청")
public record CancelSearchApiRequest(
        @Schema(description = "취소 상태 필터") List<String> statuses,
        @Schema(description = "취소 유형 필터") List<String> types,
        @Schema(description = "검색 필드 (CANCEL_NUMBER, ORDER_NUMBER 등)") String searchField,
