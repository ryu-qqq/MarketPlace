...
/**
 * SellerAddressErrorMapper - 셀러 주소 도메인 예외를 HTTP 응답으로 변환.
 *
 ...
 */
@Component
public class SellerAddressErrorMapper implements ErrorMapper {

    private static final String ERROR_TYPE_PREFIX = "/errors/seller-address";

    @Override
    public boolean supports(DomainException ex) {
        return ex instanceof SellerAddressException;
    }
