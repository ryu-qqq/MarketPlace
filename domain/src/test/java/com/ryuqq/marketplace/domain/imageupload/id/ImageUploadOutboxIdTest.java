...
@Tag("unit")
@DisplayName("ImageUploadOutboxId 테스트")
class ImageUploadOutboxIdTest {
    ...
    class OfTest {
        ...
        void createWithValidValue() {
            ImageUploadOutboxId id = ImageUploadOutboxId.of(1L);
        ...
        void createWithNull_ThrowsException() {
            assertThatThrownBy(() -> ImageUploadOutboxId.of(null))
    ...
    class ForNewTest {
        ...
        void createNewId() {
            ImageUploadOutboxId id = ImageUploadOutboxId.forNew();
