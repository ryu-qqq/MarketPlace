...
@Tag("unit")
@DisplayName("BrandPresetId Value Object 테스트")
class BrandPresetIdTest {
    ...
    class CreationTest {
        ...
        @Test
        @DisplayName("of()로 BrandPresetId를 생성한다")
        void createWithOf() {
            // when
            BrandPresetId id = BrandPresetId.of(123L);
        ...
        void ofWithNullThrowsException() {
            // when & then
            assertThatThrownBy(() -> BrandPresetId.of(null))
        ...
        void createWithForNew() {
            // when
            BrandPresetId id = BrandPresetId.forNew();
    ...
    class EqualityTest {
        ...
        @Test
        @DisplayName("같은 값을 가진 BrandPresetId는 동등하다")
        void sameValueEquals() {
            // given
            BrandPresetId id1 = BrandPresetId.of(100L);
            BrandPresetId id2 = BrandPresetId.of(100L);
        ...
        @Test
        @DisplayName("다른 값을 가진 BrandPresetId는 동등하지 않다")
        void differentValueNotEquals() {
            // given
            BrandPresetId id1 = BrandPresetId.of(100L);
            BrandPresetId id2 = BrandPresetId.of(200L);
