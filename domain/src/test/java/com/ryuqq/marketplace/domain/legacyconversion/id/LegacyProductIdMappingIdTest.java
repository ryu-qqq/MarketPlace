...
@Tag("unit")
@DisplayName("LegacyProductIdMappingId Value Object 테스트")
class LegacyProductIdMappingIdTest {
    ...
    class CreationTest {
        ...
        void ofWithNullThrowsException() {
            // when & then
            assertThatThrownBy(() -> LegacyProductIdMappingId.of(null))
        ...
        void createWithForNew() {
            // when
            LegacyProductIdMappingId id = LegacyProductIdMappingId.forNew();
    ...
    class StateCheckTest {
        ...
        void isNewReturnsTrueWhenValueIsNull() {
            assertThat(LegacyProductIdMappingId.forNew().isNew()).isTrue();
        }

        @Test
        @DisplayName("isNew()는 value가 존재하면 false를 반환한다")
        void isNewReturnsFalseWhenValueExists() {
            assertThat(LegacyProductIdMappingId.of(1L).isNew()).isFalse();
        }
    }
    ...
    class EqualityTest {
        ...
        void sameValueEquals() {
            // given
            LegacyProductIdMappingId id1 = LegacyProductIdMappingId.of(100L);
            LegacyProductIdMappingId id2 = LegacyProductIdMappingId.of(100L);
        ...
        void differentValueNotEquals() {
            // given
            LegacyProductIdMappingId id1 = LegacyProductIdMappingId.of(100L);
            LegacyProductIdMappingId id2 = LegacyProductIdMappingId.of(200L);
