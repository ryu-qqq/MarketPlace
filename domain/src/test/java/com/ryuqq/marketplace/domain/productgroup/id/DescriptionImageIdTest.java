...
@Tag("unit")
@DisplayName("DescriptionImageId Value Object 단위 테스트")
class DescriptionImageIdTest {
    ...
    class CreationTest {
        ...
        @Test
        @DisplayName("of()로 DescriptionImageId를 생성한다")
        void createWithOf() {
            // when
            DescriptionImageId id = DescriptionImageId.of(123L);
        ...
        @Test
        @DisplayName("forNew()로 새로운 DescriptionImageId를 생성한다")
    ...
    class EqualityTest {
        ...
        @Test
        @DisplayName("같은 값을 가진 DescriptionImageId는 동등하다")
        void sameValueEquals() {
            // given
            DescriptionImageId id1 = DescriptionImageId.of(100L);
            DescriptionImageId id2 = DescriptionImageId.of(100L);
        ...
        @Test
        @DisplayName("다른 값을 가진 DescriptionImageId는 동등하지 않다")
        void differentValueNotEquals() {
            // given
            DescriptionImageId id1 = DescriptionImageId.of(100L);
            DescriptionImageId id2 = DescriptionImageId.of(200L);
