...
@Tag("unit")
@DisplayName("BrandMappingSortKey 테스트")
class BrandMappingSortKeyTest {
    ...
    class SortKeyInterfaceTest {
        ...
        void implementsSortKey() {
            assertThat(BrandMappingSortKey.CREATED_AT).isInstanceOf(SortKey.class);
        }
    }
    ...
    class FieldNameTest {
        ...
        void createdAtFieldName() {
            assertThat(BrandMappingSortKey.CREATED_AT.fieldName()).isEqualTo("createdAt");
        }
    }
    ...
    class EnumValuesTest {
        ...
        void allValuesExist() {
            assertThat(BrandMappingSortKey.values())
                    .containsExactly(BrandMappingSortKey.CREATED_AT);
        }
    }
}
