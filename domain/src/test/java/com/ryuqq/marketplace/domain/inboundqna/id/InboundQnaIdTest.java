...
@Tag("unit")
@DisplayName("InboundQnaId 단위 테스트")
class InboundQnaIdTest {
    ...
    class OfTest {
        ...
        void createWithValidValue() {
            // when
            InboundQnaId id = InboundQnaId.of(1L);
        ...
        void createWithNullThrowsException() {
            assertThatThrownBy(() -> InboundQnaId.of(null))
                    .isInstanceOf(IllegalArgumentException.class)
                    .hasMessageContaining("InboundQnaId value must not be null");
        }
    }
    ...
    class ForNewTest {
        ...
        void forNewHasNullValue() {
            // when
            InboundQnaId id = InboundQnaId.forNew();
    ...
    class IsNewTest {
        ...
        void isNotNewWhenValueExists() {
            InboundQnaId id = InboundQnaId.of(100L);
    ...
    class EqualityTest {
        ...
        void sameValueAreEqual() {
            InboundQnaId id1 = InboundQnaId.of(1L);
            InboundQnaId id2 = InboundQnaId.of(1L);
        ...
        void differentValuesAreNotEqual() {
            InboundQnaId id1 = InboundQnaId.of(1L);
            InboundQnaId id2 = InboundQnaId.of(2L);
