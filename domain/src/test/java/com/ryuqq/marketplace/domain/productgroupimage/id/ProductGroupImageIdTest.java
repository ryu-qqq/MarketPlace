...
@Tag("unit")
@DisplayName("ProductGroupImageId Value Object 단위 테스트")
class ProductGroupImageIdTest {
    ...
    class CreationTest {
        ...
        @Test
        @DisplayName("of()로 ProductGroupImageId를 생성한다")
        void createWithOf() {
            // when
            ProductGroupImageId id = ProductGroupImageId.of(123L);
        ...
        @Test
        @DisplayName("forNew()로 새로운 ProductGroupImageId를 생성한다")
    ...
    class EqualityTest {
        ...
        @Test
        @DisplayName("같은 값을 가진 ProductGroupImageId는 동등하다")
        ...
        @Test
        @DisplayName("다른 값을 가진 ProductGroupImageId는 동등하지 않다")
