...
@Tag("unit")
@DisplayName("ProductGroupId Value Object 단위 테스트")
class ProductGroupIdTest {
    ...
    class CreationTest {
        ...
        @Test
        @DisplayName("of()로 ProductGroupId를 생성한다")
        void createWithOf() {
            // when
            ProductGroupId id = ProductGroupId.of(123L);
        ...
        @Test
        @DisplayName("forNew()로 새로운 ProductGroupId를 생성한다")
        void createWithForNew() {
            // when
            ProductGroupId id = ProductGroupId.forNew();
    ...
    class EqualityTest {
        ...
        void sameValueEquals() {
            // given
            ProductGroupId id1 = ProductGroupId.of(100L);
            ProductGroupId id2 = ProductGroupId.of(100L);
        ...
        void differentValueNotEquals() {
            // given
            ProductGroupId id1 = ProductGroupId.of(100L);
            ProductGroupId id2 = ProductGroupId.of(200L);
