...
@Tag("unit")
@DisplayName("ProductProfileId 단위 테스트")
class ProductProfileIdTest {
    ...
    class OfTest {
        ...
        void createWithValidValue() {
            ProductProfileId id = ProductProfileId.of(1L);
        ...
        void createWithNull_ThrowsException() {
            assertThatThrownBy(() -> ProductProfileId.of(null))
    ...
    class ForNewTest {
        ...
        void forNewCreatesIdWithNullValue() {
            ProductProfileId id = ProductProfileId.forNew();
    ...
    class EqualityTest {
        ...
        @Test
        @DisplayName("동일한 값의 ProductProfileId는 같다")
        void sameValuesAreEqual() {
            ProductProfileId id1 = ProductProfileId.of(1L);
            ProductProfileId id2 = ProductProfileId.of(1L);
        ...
        @Test
        @DisplayName("다른 값의 ProductProfileId는 같지 않다")
        void differentValuesAreNotEqual() {
            ProductProfileId id1 = ProductProfileId.of(1L);
            ProductProfileId id2 = ProductProfileId.of(2L);
