...
@Tag("unit")
@DisplayName("ProductNoticeEntryId Value Object 테스트")
class ProductNoticeEntryIdTest {
    ...
    class CreationTest {
        ...
        @Test
        @DisplayName("forNew()로 새로운 고시정보 항목용 ID를 생성한다")
    ...
    class EqualityTest {
        ...
        void sameValueEquals() {
            // given
            ProductNoticeEntryId id1 = ProductNoticeEntryId.of(500L);
            ProductNoticeEntryId id2 = ProductNoticeEntryId.of(500L);
