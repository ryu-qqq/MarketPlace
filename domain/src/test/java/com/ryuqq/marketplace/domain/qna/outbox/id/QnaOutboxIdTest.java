...
@Tag("unit")
@DisplayName("QnaOutboxId Value Object 단위 테스트")
class QnaOutboxIdTest {
    ...
    class OfTest {
        ...
        void createWithValidValue() {
            // when
            QnaOutboxId id = QnaOutboxId.of(1L);
        ...
        void createWithNullThrowsException() {
            assertThatThrownBy(() -> QnaOutboxId.of(null))
                    .isInstanceOf(IllegalArgumentException.class)
                    .hasMessageContaining("QnaOutboxId 값은 null일 수 없습니다");
        }
    }
    ...
    class ForNewTest {
        ...
        void forNewHasNullValue() {
            // when
            QnaOutboxId id = QnaOutboxId.forNew();
    ...
    class IsNewTest {
        ...
        void isNotNewWhenValueExists() {
            QnaOutboxId id = QnaOutboxId.of(100L);
    ...
    class EqualityTest {
        ...
        void sameValueAreEqual() {
            QnaOutboxId id1 = QnaOutboxId.of(1L);
            QnaOutboxId id2 = QnaOutboxId.of(1L);
        ...
        void differentValuesAreNotEqual() {
            QnaOutboxId id1 = QnaOutboxId.of(1L);
            QnaOutboxId id2 = QnaOutboxId.of(2L);
