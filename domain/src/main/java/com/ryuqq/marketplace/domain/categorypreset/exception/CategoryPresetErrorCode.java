...
public enum CategoryPresetErrorCode implements ErrorCode {
    ...
    CATEGORY_PRESET_INTERNAL_CATEGORY_NOT_FOUND("CATPRE-003", 400, "요청한 내부 카테고리를 찾을 수 없습니다"),
    CATEGORY_PRESET_SALES_CHANNEL_CATEGORY_NOT_FOUND("CATPRE-004", 404, "판매채널 카테고리를 찾을 수 없습니다");
