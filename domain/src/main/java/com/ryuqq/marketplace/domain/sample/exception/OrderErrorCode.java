 ...
 *
 * <p>Order Bounded Context의 에러 코드 정의입니다.
 *
 ...
 * </pre>
 *
 * <p><strong>ErrorCode 규칙:</strong>
 *
 * <ul>
 *   <li>✅ ErrorCode 인터페이스 구현
 *   <li>✅ Enum 타입으로 정의
 *   <li>✅ HTTP 상태 코드는 int 타입 (Spring HttpStatus 의존성 금지)
 *   <li>✅ 명확한 에러 메시지
 *   <li>✅ 일관된 코드 형식 (ORDER-001, ORDER-002 등)
 * </ul>
 *
