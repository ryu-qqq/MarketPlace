...
import com.ryuqq.marketplace.domain.common.model.ValueObject;
 ...
 * </pre>
 *
 * <p><strong>Value Object 패턴:</strong>
 *
 * <ul>
 *   <li>✅ Record 타입 (불변)
 *   <li>✅ ValueObject 인터페이스 구현
 *   <li>✅ of() Factory Method
 *   <li>✅ 생성자 검증
 *   <li>✅ 비즈니스 로직 포함 (add, subtract 등)
 * </ul>
 *
 * @author ryu-qqq
 * @since 2025-11-21
