package com.ryuqq.marketplace.domain.sample.vo;

import com.ryuqq.marketplace.domain.common.model.Identifier;

/**
 * Sample Order Identifier (예시)
 *
 * <p>이 클래스는 Order Aggregate의 Identifier 예시입니다.
 *
 ...
 * @see Identifier
 */
public record SampleOrderId(Long value) implements Identifier<Long> {
     ...
     *
     * <p>저장되지 않은 새 Aggregate 생성 시 사용합니다.
     *
     ...
     * 새 Entity 여부 확인
     *
     * <p>DB에 저장되지 않은 새 Entity인지 확인합니다.
     *
