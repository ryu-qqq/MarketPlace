...
# Service Discovery DNS: marketplace-scheduler.connectly.local
# ========================================
...
resource "aws_kms_key" "logs" {
  description             = "KMS key for MarketPlace scheduler CloudWatch logs encryption"
...
module "ecs_service" {
  ...
  # health_check_grace_period_seconds not needed without LB
...
output "service_discovery_dns" {
  ...
  value       = "marketplace-scheduler.connectly.local"
}
