# ========================================
# ElastiCache (Redis) for MarketPlace
# ========================================
# Redis cluster using Infrastructure module
# Naming: marketplace-redis-prod
# Usage: Redisson Lock + Cache
# ========================================
...
resource "aws_ssm_parameter" "redis_endpoint" {
  ...
  description = "MarketPlace Redis endpoint"
  type        = "String"
...
resource "aws_ssm_parameter" "redis_port" {
  ...
  description = "MarketPlace Redis port"
  type        = "String"
