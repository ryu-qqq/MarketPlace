# ========================================
# ECS Service: legacy-api (Stage)
# ========================================
# 레거시(세토프) 호환 REST API 전용 서버
# Port: 8081
# Service Discovery DNS: marketplace-legacy-api-stage.connectly.local
# ========================================
...
resource "aws_kms_key" "logs" {
  description             = "KMS key for MarketPlace legacy-api CloudWatch logs encryption (stage)"
...
resource "aws_security_group_rule" "ecs_to_rds" {
  ...
  description              = "Allow marketplace-legacy-api-stage ECS to access staging RDS"
}
...
output "service_discovery_dns" {
  ...
  value       = "marketplace-legacy-api-stage.connectly.local"
}
