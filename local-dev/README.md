# MarketPlace 로컬 개발 환경

로컬에서 MarketPlace를 개발하고 테스트하기 위한 Docker Compose 환경 모음입니다.
...
| 서비스 | 로컬 환경 | AWS 환경 |
|--------|----------|----------|
| Web API | http://localhost:8080 | http://localhost:9090 |
...
- [MarketPlace 아키텍처 문서](../docs/ARCHITECTURE.md)
